##################################
## Data process for mRNA and miRNA
#################################
library(data.table)
library(readxl)
#-----------------------------------------------------------------------------------
########################## TCGA mRNA ###########################################
#---------------------------------------------------------------------------------
dt<- fread("/home/4467777/TCGA_shiny/data/EBPlusPlusAdjustPANCAN_IlluminaHiSeq_RNASeqV2.geneExp.tsv")
...
write.fst(geneName,"/home/4467777/TCGA_shiny/data/mrna/geneName_mrna.fst")

rownames(dt) = dt$gene_id
dt = data.frame(dt[,-1])
save(dt,file = "/home/4467777/TCGA_shiny/data/mrna/mRNA.RData")


#----------------------- merge with purity data --------------------------------
# Import all the purity data
setwd("/home/4467777/TCGA_shiny/data/mrna/purity/")
...
load("/home/4467777/TCGA_shiny/data/mrna/mRNA_clin.RData") # n =10069
dt = merge(purity,dt,by.x="sampleid",by.y ="Row.names",all.y=TRUE)
names(dt)[1]="Row.names"
save(dt,file = "/home/4467777/TCGA_shiny/data/mrna/mRNA_clin.RData")
